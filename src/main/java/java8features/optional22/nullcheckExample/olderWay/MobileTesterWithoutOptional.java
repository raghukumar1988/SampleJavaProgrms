...
public class MobileTesterWithoutOptional {
    ...
    public static void main(String[] args) {
        ...
        Mobile mobile = new Mobile(2015001, "Apple", "iPhone 17s", displayFeatures);
        int mobileWidth = mService.getMobileScreenWidth(mobile);
        System.out.println("Apple iPhone 17s Screen Width = " + mobileWidth);
        ...
        Mobile mobile2 = new Mobile(2015001, "Apple", "iPhone 16s", displayFeatures2);
