package multithreading.udemyCourse;// Producer and Consumer problem
...
class MessageQueue {
    ...
    public synchronized void enqueue(String msg) {
        while (isFull()) { // try to understand why it become while from 'if'
            try {
                this.wait();
...
public class Test17ProducerConsumerProblem {
